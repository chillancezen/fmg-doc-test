:source: fmgr_firewall_internetservicegroup.py

:orphan:

.. _fmgr_firewall_internetservicegroup:
...
.. raw:: html
 ...
 <tr>
 <td>firewall_internetservicegroup</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_internetservicegroup</span> - no description <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">member</span> - Internet Service group member. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">name</span> - Internet Service group name. <span class="li-normal">type: str</span>  <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">direction</span> - How this service may be used (source, destination or both). <span class="li-normal">type: str</span>  <span class="li-normal">choices: [both, source, destination]</span>  <a id='label6' href="javascript:ContentClick('label7', 'label6');" onmouseover="ContentPreview('label7');" onmouseout="ContentUnpreview('label7');" title="click to collapse or expand..."> more... </a>
